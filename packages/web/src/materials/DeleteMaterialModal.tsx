...
const DeleteMaterialModal = ({ isOpen, toggle, onDeleteAction }) => {
  ...
  return (
    <Modal isOpen={isOpen} toggle={toggle} skipOutsideClickEvent={true}>
      <Modal.Header toggle={toggle}>Delete Material</Modal.Header>
      <Modal.Body>
        <div>
          <p>Are you sure for permanently delete this material?</p>
        </div>
      </Modal.Body>
      <Modal.Footer>
