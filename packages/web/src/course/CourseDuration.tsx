...
export const CourseDuration: FC<ICourseDuration> = (props) => {
    ...
    <div>
      ...
      <div className="mb-3 flex w-1/4 flex-row items-center space-x-4">
        <InputSection
          ...
          placeholder={t('courseForm.durationMonth')}
      ...
      <div className="mb-3 flex w-1/4 flex-row items-center space-x-4">
        <InputSection
          ...
          placeholder={t('courseForm.durationWeek')}
          inputWrapperClassName="mr-1"
          inputClassName="h-51px"
      ...
      <div className="mb-3 flex w-1/4 flex-row items-center space-x-4">
        <InputSection
          ...
          max={365}
          name={fieldDays.name}
          placeholder={t('courseForm.durationDay')}
          inputWrapperClassName="mr-1"
          inputClassName="h-51px"
      ...
      <div className="mb-3 flex w-1/4 flex-row items-center space-x-4">
        <InputSection
          ...
          placeholder={t('courseForm.durationHour')}
          inputWrapperClassName="mr-1"
          inputClassName="h-51px"
      ...
      <div className="mb-3 flex w-1/4 flex-row items-center space-x-4">
        <InputSection
          ...
          placeholder={t('courseForm.durationMinute')}
          inputWrapperClassName="mr-1"
          inputClassName="h-51px"
