...
interface IRemoveOutlinesFromBundleModal {
  isOpen: boolean;
  toggle: (bool?) => void;
  onConfirm: () => void;
  checkedRows: string[];
...
const RemoveOutlinesFromBundleModal: FC<IRemoveOutlinesFromBundleModal> = ({
  isOpen,
  toggle,
  onConfirm,
  checkedRows,
    ...
    >
      <Dialog.Title as="div" className="flex flex-row justify-between">
        <p className="text-heading font-bold">
          {t('courseOutlineBundlePage.removeOutlinesModalHeading')}
        </p>
        <Close
      ...
      <div className="flex flex-col space-y-4">
        <p>
          {t('courseOutlineBundlePage.removeOutlinesInfo', {
...
export default RemoveOutlinesFromBundleModal;
