...
const DeleteTopicModal = ({ isOpen, toggle, onDeleteAction }) => {
  ...
  return (
    <Modal isOpen={isOpen} toggle={toggle} skipOutsideClickEvent={true}>
      <Modal.Header toggle={toggle}>Delete Topic</Modal.Header>
      <Modal.Body>
        <div>
          <p>Are you sure for permanently delete this topic?</p>
        </div>
      </Modal.Body>
      <Modal.Footer>
