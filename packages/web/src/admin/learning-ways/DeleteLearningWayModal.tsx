...
const DeleteLearningWayModal = ({ isOpen, toggle, onDeleteAction }) => {
  ...
  return (
    <Modal isOpen={isOpen} toggle={toggle} skipOutsideClickEvent={true}>
      <Modal.Header toggle={toggle}>Delete learning way</Modal.Header>
      <Modal.Body>
        <div>
          <p>Are you sure for permanently delete this learning way?</p>
        </div>
      </Modal.Body>
      <Modal.Footer>
...
export default DeleteLearningWayModal;
