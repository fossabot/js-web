// https://oozou.slack.com/files/U026Z1MUSQN/F0289Q73E3V/align-seac-crm-api_spec-13052021-v11.pdf
...
export class CRMContactRetailPaidV11 {
  @IsString()
  @Length(0, 100)
  ...
  @IsNumber()
  @IsEqual<CRMContactRetailPaidV11>(
  ...
  @IsString()
  @IsNotEmpty()
  @IsEqual<CRMContactRetailPaidV11>((self) =>
